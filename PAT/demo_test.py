...
from datasets import TestSetLoader, TestSetMultiLoader, TestDriggersLoader, TestRealLoader
...
def main(cfg):
    test_set = TestDriggersLoader(dataset_dir=cfg.testset_dir + '/' + cfg.dataset, scale_factor=cfg.scale_factor)
